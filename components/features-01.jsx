...
import FeatureImage02 from "@/public/images/feats1.jpg"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 mb-4">
              Grow your brand like you do in your dreams
            </h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              <button
                className={`text-left px-4 py-5 border border-transparent rounded ${tab !== 1
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <svg
                    className={`fill-zinc-400 shrink-0 ml-2 ${tab !== 1 ? "hidden" : ""
                      }`}
                ...
                <div className="text-sm text-zinc-500">
                  Description Number One FTC
                </div>
              </button>
              <button
                className={`text-left px-4 py-5 border border-transparent rounded ${tab !== 2
                    ? "bg-zinc-100 opacity-60 hover:opacity-100 transition"
                    : "[background:linear-gradient(theme(colors.white),theme(colors.white))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] shadow-sm rotate-1"
                  }`}
                onClick={e => {
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <svg
                    className={`fill-zinc-400 shrink-0 ml-2 ${tab !== 2 ? "hidden" : ""
                      }`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="10"
                    height="10"
                ...
                <div className="text-sm text-zinc-500">
                  Description Number Two FTC
                </div>
              </button>
              <button
                className={`text-left px-4 py-5 border border-transparent rounded ${tab !== 3
                    ? "bg-zinc-100 opacity-60 hover:opacity-100 transition"
                    : "[background:linear-gradient(theme(colors.white),theme(colors.white))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] shadow-sm rotate-1"
                  }`}
                onClick={e => {
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <svg
                    className={`fill-zinc-400 shrink-0 ml-2 ${tab !== 3 ? "hidden" : ""
                      }`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="10"
                    height="10"
                ...
                <div className="text-sm text-zinc-500">
                  Description Number Three FTC
                </div>
              </button>
              <button
                className={`text-left px-4 py-5 border border-transparent rounded ${tab !== 4
                    ? "bg-zinc-100 opacity-60 hover:opacity-100 transition"
                    : "[background:linear-gradient(theme(colors.white),theme(colors.white))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] shadow-sm rotate-1"
                  }`}
                onClick={e => {
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <svg
                    className={`fill-zinc-400 shrink-0 ml-2 ${tab !== 4 ? "hidden" : ""
                      }`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="10"
                    height="10"
