...
function TriggerGroup({ as: Component = "div", children, className, ...props }) {
...
export function ReactorGroup({ as: Component = "div", children, className, ...props }) {
  const container = useRef(null)
...
export function Reactor({ as: Component = "div", children, className, ...props }) {
  const container = useRef(null)
