...
import CarouselIllustration2 from "@/public/images/carousel-illustration-02.jpg"
...
export default function Hero() {
  return (
    <section className="relative before:absolute before:inset-0 before:h-80 before:pointer-events-none before:bg-gradient-to-b before:from-zinc-100 before:-z-10">
      <div className="pt-32 pb-12 md:pt-40 md:pb-20" data-aos="fade-down">
        {/* Section content */}
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center pb-12 md:pb-16">
              ...
              <p className="text-lg text-zinc-500 mb-8">
                Turbocharge your growth with a Doll, the agency that gives creatives the power of creating without
                limits.
              </p>
